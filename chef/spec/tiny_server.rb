...
# This should be rewritten to not use Thin (which requires eventmachine) so it can run under Windows.
# http://rack.rubyforge.org/doc/Rack/Handler/WEBrick.html
fail "Do not require this under windows" if windows?
